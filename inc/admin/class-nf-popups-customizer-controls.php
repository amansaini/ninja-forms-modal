	...
	public static function add_controls() {
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				$wp_customize,
				'nf_popups_overlay_color_control',
				array(
		...
		$wp_customize->add_control(
			'nf_popups_overlay_opacity_control',
			array(
				'type'        => 'range',
				'priority'    => 90,
				'section'     => 'nf_popups_overlay_settings',
		...
		$wp_customize->add_control(
			'nf_popups_container_padding_control',
			array(
				'type'        => 'range',
				'priority'    => 90,
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				$wp_customize,
				'nf_popups_container_background_color_control',
				array(
		...
		$wp_customize->add_control(
			'nf_popups_container_width_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
				'section'     => 'nf_popups_container_settings',
		...
		$wp_customize->add_control(
			'nf_popups_container_height_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
		...
		$wp_customize->add_control(
			'nf_popups_container_width_mobile_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
				'section'     => 'nf_popups_container_settings',
		...
		$wp_customize->add_control(
			'nf_popups_container_height_mobile_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
				'description' => 'Height in px or percentage, e.g 200px, 80% or auto',
		...
		$wp_customize->add_control(
			'nf_popups_container_border_radius_control',
			array(
				'type'        => 'range',
				'priority'    => 90,
				'section'     => 'nf_popups_container_settings',
		...
		$wp_customize->add_control(
			'nf_popups_container_border_thickness_control',
			array(
				'type'        => 'range',
				'priority'    => 90,
				'section'     => 'nf_popups_container_settings',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				$wp_customize,
				'nf_popups_container_border_color_control',
				array(
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				$wp_customize,
				'nf_popups_container_border_style_control',
				array(
		...
		if ( ! defined( 'NF_POPUPS_ANIMATIONS_VERSION' ) ) {
			$animate_description = 'Want more animations ? Try <a href="https://webholics.org/downloads/popup-add-on-for-ninja-forms-pro/" target="_blank">animations addon</a>';
		} else {
			$animate_description = '';
		}
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				$wp_customize,
				'nf_popups_open_animation_control',
				array(
		...
		// ) ) );
		$wp_customize->add_control(
			'nf_popups_close_btn_top_margin_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
		...
		$wp_customize->add_control(
			'nf_popups_close_btn_right_margin_control',
			array(
				'type'        => 'text',
				'priority'    => 90,
